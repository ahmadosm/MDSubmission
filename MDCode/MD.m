...
global MassModmin MassModmax

MassModmin = rand()*4 + 1; %randomizes a minimum atomic mass for Mass 1
MassModmax = rand()*13 + 1; %randomizes a maximum atmoic mass for Mass 0
